...
public class PostOrderVisitorTest {
    ...
    public void testVisitSingleNode() {
        ...
        INodeVisitor<Card> v = new PostOrderVisitor<>();
    ...
    public void testVisitLargerTree() {
        ...
        INodeVisitor<Card> v = new PostOrderVisitor<>();
        String expected = "CAR: 'D'; CAR: 'C'; CAR: 'B'; CAR: 'A'; ";
    ...
    public void testVisitBiggerTree() {
        ...
        String expected =
                "CAR: 'Car_3'; BOAT: 'Boat_3'; MOTORCYCLE: 'Motorcycle_3'; MOTORCYCLE:"
                    ...
                    + " AIRPLANE: 'Airplane_4'; CAR: 'Car_1'; CAR: 'Car_2'; AIRPLANE: 'Airplane_1';"
                    + " AIRPLANE: 'Airplane_2'; CAR: 'Car_5'; AIRPLANE: 'Airplane_3'; BOAT:"
                    + " 'Boat_2'; BOAT: 'Boat_4'; BOAT: 'Boat_1'; CAR: 'Car_4'; ";
